document.addEventListener("DOMContentLoaded", () => {
    ...
    const examCards = [
        { name: "Supervised NCLEX-RN Mock", date: "2026-05-15", locked: false, href: "../exam-lobby/exam-lobby.html" },
        { name: "Pharmacology Proctored Exam", date: "2026-05-18", locked: true, href: "../exam-lobby/exam-lobby.html" }
    ];
