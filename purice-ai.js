...
const knowledgeBase = [
    ...
    },
    {
        ...
        answer: "Certificates appear after you complete the required course or exam activities. Open My Learnings from the student menu to track completion and view available certificate downloads."
    },
    {
    ...
    },
    {
        ...
        answer: "After login, use the student side menu for Dashboard, Courses, Licensing, Exams, Research Support, My Learning, Profile, and Help & Support. Paid learning materials appear only in the purchased course."
    },
    {
        keys: ["software", "system", "platform", "app", "website", "navigation", "navigate", "use the site", "how to use"],
        answer: "Global NursePrep works in a simple flow: browse public information first, create an account or login, choose a course or licensing track, pay for the selected item, then access that item from the student workspace. Protected pages such as My Learnings, Exams, Profile, student support, and paid resources require login."
    },
    {
    ...
    },
    {
        ...
        answer: "Use the menu or sidebar to move around the platform. Courses opens the course catalog, Licensing opens international exam preparation, My Learnings shows enrolled courses and certificates, Profile manages your account, and Help & Support opens student support."
    }
];
