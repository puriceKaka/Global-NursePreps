(() => {
    ...
    function syncDrawerOffset() {
        const header = document.querySelector(".topbar, .lms-nav, .navbar, .header, .public-nav");
    ...
    function renderStudentDrawerMenu() {
        ...
        const links = [
            ...
            ["Licensing", `${root}student-licensing.html`],
            ...
            ["Help & Support", `${root}student-support.html`]
        ];
